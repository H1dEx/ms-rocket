...
import (
	...
	model "github.com/H1dEx/ms-rocket/inventory/internal/model"
...
func (_m *InventoryService) GetList(ctx context.Context, filter *model.PartFilter) ([]model.Part, error) {
...
// InventoryService_GetList_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetList'
type InventoryService_GetList_Call struct {
	*mock.Call
}
...
func (_e *InventoryService_Expecter) GetList(ctx interface{}, filter interface{}) *InventoryService_GetList_Call {
	return &InventoryService_GetList_Call{Call: _e.mock.On("GetList", ctx, filter)}
}

func (_c *InventoryService_GetList_Call) Run(run func(ctx context.Context, filter *model.PartFilter)) *InventoryService_GetList_Call {
...
func (_c *InventoryService_GetList_Call) Return(_a0 []model.Part, _a1 error) *InventoryService_GetList_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *InventoryService_GetList_Call) RunAndReturn(run func(context.Context, *model.PartFilter) ([]model.Part, error)) *InventoryService_GetList_Call {
	_c.Call.Return(run)
	return _c
}

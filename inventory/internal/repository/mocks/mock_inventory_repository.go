...
func (_m *InventoryRepository) ListParts(ctx context.Context, filter *model.PartFilter) ([]model.Part, error) {
...
func (_c *InventoryRepository_ListParts_Call) Run(run func(ctx context.Context, filter *model.PartFilter)) *InventoryRepository_ListParts_Call {
	_c.Call.Run(func(args mock.Arguments) {

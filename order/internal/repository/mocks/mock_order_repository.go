...
func (_c *OrderRepository_CreateOrder_Call) RunAndReturn(run func(context.Context, string, string, []string, float32) error) *OrderRepository_CreateOrder_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *OrderRepository) UpdateOrder(ctx context.Context, params model.UpdateOrderParam) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, model.UpdateOrderParam) error); ok {
		r0 = rf(ctx, params)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *OrderRepository_UpdateOrder_Call) Run(run func(ctx context.Context, params model.UpdateOrderParam)) *OrderRepository_UpdateOrder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.UpdateOrderParam))
	})
	return _c
}
...
func (_c *OrderRepository_UpdateOrder_Call) RunAndReturn(run func(context.Context, model.UpdateOrderParam) error) *OrderRepository_UpdateOrder_Call {
	_c.Call.Return(run)
	return _c
}

...
type NotificationMethod struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Провайдер: telegram, email, push и т.д.
	ProviderName string `protobuf:"bytes,1,opt,name=provider_name,json=providerName,proto3" json:"provider_name,omitempty"`
	// Адрес/идентификатор назначения (email, чат-id)
...
const file_common_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x14common/v1/user.proto\x12\tcommon.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb9\x01\n" +
	"\x04User\x12\x12\n" +
	...
	"\x06target\x18\x02 \x01(\tR\x06targetBAZ?github.com/H1dEx/ms-rocket/shared/pkg/proto/common/v1;common_v1b\x06proto3"

...
// PayOrder provides a mock function with given fields: _a0
func (_m *PaymentService) PayOrder(_a0 context.Context) (string, error) {
	ret := _m.Called(_a0)
...
//   - _a0 context.Context
func (_e *PaymentService_Expecter) PayOrder(_a0 interface{}) *PaymentService_PayOrder_Call {
	return &PaymentService_PayOrder_Call{Call: _e.mock.On("PayOrder", _a0)}
}

func (_c *PaymentService_PayOrder_Call) Run(run func(_a0 context.Context)) *PaymentService_PayOrder_Call {
